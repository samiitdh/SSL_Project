...
// $write =  ($connect, "CREATE TABLE `adiutor`.`courses` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `instuctor` VARCHAR(32) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");

$write = mysqli_query($connect,"CREATE TABLE `adiutor`.`courses` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `instuctor` VARCHAR(255) NOT NULL , `roll_number` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;")
?>