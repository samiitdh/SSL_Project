...
$write = mysqli_query($connect,"CREATE TABLE `adiutor`.`unique_id` ( `unique_id` INT(255) NOT NULL AUTO_INCREMENT , `description` MEDIUMTEXT NOT NULL , PRIMARY KEY (`unique_id`)) ENGINE = InnoDB; ");
